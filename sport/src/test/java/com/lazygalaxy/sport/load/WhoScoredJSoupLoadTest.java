...
public class WhoScoredJSoupLoadTest extends TestCase {
	...
	public void testMatch() throws Exception {
		...
		// Set<String> links =
		// scraper.getLinks("html/whoscored-football-201708-fixtures.html");
		//
	...
	public void testPlayer1() throws Exception {
		...
		//
		// Player player =
		// scraper.getMongoDocuments("html/whoscored-football-19921023_alvaromorata.html");
		...
		// assertEquals(countryHelper.getDocumentById("es").id,
		// player.countryId);
		// assertEquals(teamHelper.getDocumentByLabel("Chelsea").id,
		// player.teamId);
	...
	public void testPlayer2() throws Exception {
		...
		//
		// Player player =
		// scraper.getMongoDocuments("html/whoscored-football-19910628_kevindebruyne.html");
		...
		// assertEquals(countryHelper.getDocumentById("be").id,
		// player.countryId);
		// assertEquals(teamHelper.getDocumentByLabel("Manchester City").id,
		// player.teamId);
